    ...
    return (
        <div className='inclusao-container'>
            ...
            <div className='inclusao-frame'>
                ...
                <MultiSelect value={selectedCurrency} onChange={(e: MultiSelectChangeEvent) => setSelectedCurrency(e.value)} options={currencyTypes} display="chip" optionLabel="currency"
