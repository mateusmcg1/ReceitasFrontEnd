...
export default function NewTransaction({ walletId, closeDialog, walletCurrency, toast }: { walletId: string, closeDialog: any, walletCurrency: CurrencyEnum, toast: any }) {
